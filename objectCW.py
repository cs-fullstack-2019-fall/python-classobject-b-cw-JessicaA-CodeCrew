...
# !! : main function to call your problem functions 
# Problem 1:
...
def problem2():
    userInput = ""
    while (userInput != 'q'):
        userInput = input("Enter another string:  ") # !! : quits with the equal sign
problem2()
...
def problem3():
    ...
    option1.changeName("TEST1a")
    print(option1.name, option1.price, option1.quantity)
    option1.changeNamePrice("TEST2a", "TEST2b")
    print(option1.name, option1.price, option1.quantity)
    option1.changeAll("TEST3a", "TEST3b", "TEST3c")
    print(option1.name, option1.price, option1.quantity)
problem3()